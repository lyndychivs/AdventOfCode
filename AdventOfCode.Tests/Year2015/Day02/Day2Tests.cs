    ...
    public class Day2Tests
    {
        ...
        public void Day2_Part1()
        {
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(part1.CalculateWrappingPaperForAllBoxes(FileOperations.GetInputFileContent("Year2015\\Day02\\input.txt")), Is.EqualTo(1598415));
            }
        }
        ...
        public void Day2_Part2()
        {
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(part2.CalculateRibbonForAllBoxes(FileOperations.GetInputFileContent("Year2015\\Day02\\input.txt")), Is.EqualTo(3812909));
            }
        }
    }
}