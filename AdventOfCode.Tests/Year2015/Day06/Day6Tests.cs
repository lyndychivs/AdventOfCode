    ...
    public class Day6Tests
    {
        ...
        public void Day6_Part1()
        {
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(new Part1().GetTotalLightsOnFromInstructions(FileOperations.GetInputFileContent("Year2015\\Day06\\input.txt")), Is.EqualTo(569_999));
            }
        }
        ...
        public void Day6_Part2()
        {
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(new Part2().GetTotalLightsBrightnessCountFromInstructions(FileOperations.GetInputFileContent("Year2015\\Day06\\input.txt")), Is.EqualTo(17_836_115));
            }
        }
    }
}